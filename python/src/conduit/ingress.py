...
def _tools_list(runtime: "Runtime", raw_id: str, params: dict[str, object]) -> Response:
...
async def _tools_call(runtime: "Runtime", request: Request, raw_id: str, params: dict[str, object]) -> Response:
